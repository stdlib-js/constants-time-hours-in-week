...
```javascript
import HOURS_IN_WEEK from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-hours-in-week@v0.3.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-time-hours-in-week/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/constants-time-hours-in-week/actions/workflows/test.yml?query=branch:v0.3.1
