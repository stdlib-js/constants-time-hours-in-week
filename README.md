...
```javascript
HOURS_IN_WEEK = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-hours-in-week@v0.0.8-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-hours-in-week@v0.0.8-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/constants-time-hours-in-week/actions/workflows/test.yml/badge.svg?branch=v0.0.8
[test-url]: https://github.com/stdlib-js/constants-time-hours-in-week/actions/workflows/test.yml?query=branch:v0.0.8
